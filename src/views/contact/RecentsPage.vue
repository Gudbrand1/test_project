    ...
    <div class="recents">
      <div class="column">
        <div v-for="contacts in array" :key="contacts.id">
          <div class="MultipleContact">
            <p class="letter">{{ contacts.date }}</p>
                ...
                <div class="contactInfos">
                  ...
                  <div class="contactInfosText">
                    ...
                    <div class="spanHolder">
                      ...
                      <span>
                        {{ contact.callType }}
                        <!-- Placeholder fetch some icons and add them here -->
                      </span>
                      <span>
                        {{ contact.time }}
                      </span>
...
import ContactRecent from "@/assets/placeholder/contactRecents";
import { FullnameMixin } from "@/mixins/fullnameMixin";

@Component({
  components: { ContactFirstRow, ContactBottomNav },
})
export default class Recents extends Mixins(FullnameMixin) {
  array = ContactRecent;
}
</script>
